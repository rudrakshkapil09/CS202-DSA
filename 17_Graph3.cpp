//Graph - Compact array of linked lists
#include <iostream>
using namespace std;
const int nv = 5;
        ...
        if (G->key == start) return 1;
            ...
            while (G->dtlink) {
                ...
                if (loop_cnt > nv) return 1;
                    ...
                    int check = isCyclic(orG, G->dtlink->key, start, 1, ac_cnt, loop_cnt+1);
...
int main()
{
    ...
    string input_DG = "B0C0D0E0B0";   //BD0CE0AD0E00  //CD0AE0BD0E00 //D0CE0AD0E00
    //B0C0D0E0B0
